...
public class Land {
	...
	Land(String landName, int villaPrice, int buildingPrice, int hotelPrice ,int amountVilla , int amountBuilding, int amountHotel , int constructionCost, String landowner){
